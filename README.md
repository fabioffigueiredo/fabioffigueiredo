...
Cientista de Dados Sênior com **11+ anos de experiência** consolidada em TI, infraestrutura e cloud, agora aplicando essa expertise na vanguarda da **Inteligência Artificial, Machine Learning e Governança de Dados**. 

Adoto a metodologia **AI FIRST** para transformar dados complexos em soluções inovadoras que geram impacto real no negócio, sempre com foco em qualidade, segurança e conformidade.

### 🎯 Especialidades Principais

- **Data Science & AI**: Machine Learning avançado, Deep Learning, NLP, Computer Vision
- **Generative AI**: RAG (Retrieval-Augmented Generation), LLMs, Prompt Engineering
- **MLOps & Infrastructure**: Kubernetes (k3s), Docker, CI/CD (GitLab, ArgoCD), on-premise deployment
- **Data Engineering**: ETL pipelines, Vector Databases, Big Data processing
- **Data Governance**: Compliance, Data Quality, Security in Financial Sector
...
- Projetos estratégicos de IA e análise preditiva para o setor financeiro (BB Asset)
- Automação inteligente com Machine Learning e processamento de dados em tempo real

🌱 **Aprofundando conhecimentos em**:
- Deep Learning avançado e NLP na Pós-Graduação MIT em IA
- Modelos de linguagem em larga escala e otimização de inferência

---

## 💼 Experiência Profissional

| Cargo | Empresa | Período | Destaques |
|-------|---------|---------|----------|
| **Senior Data Scientist** | BB Asset (via Globalweb) | Fev 2026 - Atual | Governança de Dados, Modelos de IA, Análise Preditiva |
| **AI & Infrastructure Engineer** | Lumina Lab | Out 2025 - Fev 2026 | Kubernetes, RAG, GenAI, Monitoramento com IA |
| **Systems & Data Analyst** | Megatrax Brasil | Jan 2019 - Atual | ETL, Python, Power BI, AWS, -70% no processamento |
...
### IA & Machine Learning
![Artificial Intelligence](https://img.shields.io/badge/Artificial_Intelligence-449794?style=for-the-badge&logo=artificial-intelligence&logoColor=white)
![Machine Learning](https://img.shields.io/badge/Machine_Learning-FFB800?style=for-the-badge&logo=CNEF&logoColor=black)
...
- **Pós-Graduação MIT** em Inteligência Artificial, Machine Learning e Deep Learning - Instituto Infnet (2025-2026)
- **Bacharelado** em Sistemas de Informação - Universidade Estácio de Sá (2020)
- **Bootcamps & Certificações**: DIO - Python, FastAPI, TDD, Santander 2025
...
- 🤖 Engenharia de Dados e IA Generativa
- 📊 Machine Learning em Produção
- ☸️ Kubernetes, DevOps e CI/CD
- 💰 Governança de Dados no setor financeiro
- 🔬 Deep Learning e NLP
...
[![Gmail](https://img.shields.io/badge/-Gmail-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:fabioinfirmacao@gmail.com)
...
![GitHub Stats](https://github-readme-stats.vercel.app/api?username=fabioffigueiredo&theme=dark&show_icons=true&include_all_commits=true&count_private=true&hide=stars&cache_seconds=86400)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=fabioffigueiredo&theme=dark&layout=compact&cache_seconds=86400)
